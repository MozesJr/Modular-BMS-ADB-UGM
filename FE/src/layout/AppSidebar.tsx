...
const AppSidebar: React.FC = () => {
  ...
  return (
    <aside
      className={`dark fixed flex flex-col top-0 px-5 left-0 bg-gray-900 border-gray-800 text-gray-300 h-screen overflow-y-auto no-scrollbar transition-all duration-300 ease-in-out z-50 border-r
        ${
    ...
    >
      ...
      >
        <Link href="/">
          {isExpanded || isHovered || isMobileOpen ? (
            /* Tambahkan flex dan items-center di sini agar logo dan teks sejajar ke samping */
      ...
      <div className="flex flex-col overflow-y-auto duration-300 ease-linear no-scrollbar">
        <nav className="mb-6">
          <div className="flex flex-col gap-4">
            <div>
              <h2
                className={`mb-4 text-xs uppercase flex leading-[20px] text-gray-500 ${
                  !isExpanded && !isHovered
                    ? "lg:justify-center"
                    : "justify-start"
                }`}
