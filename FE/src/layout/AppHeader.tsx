        ...
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          ...
          <div className="hidden lg:block">
            <button
              ...
              className="relative flex h-11 w-full items-center rounded-lg border border-gray-200 bg-transparent py-2.5 pl-12 pr-14 text-sm text-gray-400 shadow-theme-xs hover:border-brand-300 dark:border-gray-800 dark:bg-white/[0.03] xl:w-[430px]"
            >
              ...
              <span>Cari device, halaman, aksi…</span>
        ...
        >
          <div className="flex items-center gap-2 2xsm:gap-3">
            ...
            <button
              ...
              className="flex h-10 w-10 items-center justify-center rounded-lg border border-gray-200 text-gray-500 hover:bg-gray-100 dark:border-gray-800 dark:text-gray-400 dark:hover:bg-gray-800 lg:hidden"
            >
