#!/usr/bin/env bash
# Menjalankan seluruh tes BE termasuk tes integrasi DB terhadap Postgres SEKALI-PAKAI di Docker.
...
# Pakai:  npm run test:db      (butuh Docker; port host bisa diubah dengan TEST_DB_PORT)
set -euo pipefail
